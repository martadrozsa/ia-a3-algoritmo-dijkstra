...
public class Maze02 {
    ...
    public void createGraph() {
        ...
        linkNodeTo(node1_1, baseWeight, node1_0, node1_2);
        linkNodeTo(node1_1, heavyWeight, node2_1);
        ...
        linkNodeTo(node2_1, baseWeight, node1_1);
        linkNodeTo(node2_1, heavyWeight, node3_1);
        linkNodeTo(node2_3, baseWeight, node1_3, node3_3);
        linkNodeTo(node2_5, baseWeight, node1_5, node3_5);

        linkNodeTo(node3_1, heavyWeight, node2_1, node4_1);
        ...
        linkNodeTo(node4_1, heavyWeight, node3_1, node5_1);
        linkNodeTo(node4_5, baseWeight, node3_5, node5_5);

        linkNodeTo(node5_1, heavyWeight, node4_1, node5_2);
        linkNodeTo(node5_2, heavyWeight, node5_1);
        linkNodeTo(node5_2, baseWeight, node5_3);
